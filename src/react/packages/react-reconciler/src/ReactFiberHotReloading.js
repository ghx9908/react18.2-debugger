...
export const setRefreshHandler = enableNewReconciler ? setRefreshHandler_new : setRefreshHandler_old;
export const resolveFunctionForHotReloading = enableNewReconciler ? resolveFunctionForHotReloading_new : resolveFunctionForHotReloading_old;
export const resolveClassForHotReloading = enableNewReconciler ? resolveClassForHotReloading_new : resolveClassForHotReloading_old;
export const resolveForwardRefForHotReloading = enableNewReconciler ? resolveForwardRefForHotReloading_new : resolveForwardRefForHotReloading_old;
export const isCompatibleFamilyForHotReloading = enableNewReconciler ? isCompatibleFamilyForHotReloading_new : isCompatibleFamilyForHotReloading_old;
export const markFailedErrorBoundaryForHotReloading = enableNewReconciler ? markFailedErrorBoundaryForHotReloading_new : markFailedErrorBoundaryForHotReloading_old;
export const scheduleRefresh = enableNewReconciler ? scheduleRefresh_new : scheduleRefresh_old;
export const scheduleRoot = enableNewReconciler ? scheduleRoot_new : scheduleRoot_old;
export const findHostInstancesForRefresh = enableNewReconciler ? findHostInstancesForRefresh_new : findHostInstancesForRefresh_old;
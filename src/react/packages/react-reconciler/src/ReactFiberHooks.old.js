...
import { NoLane, SyncLane, OffscreenLane, NoLanes, isSubsetOfLanes, includesBlockingLane, includesOnlyNonUrgentLanes, claimNextTransitionLane, mergeLanes, removeLanes, intersectLanes, isTransitionLane, markRootEntangled, markRootMutableRead, NoTimestamp } from './ReactFiberLane.old';
...
import { getWorkInProgressRoot, getWorkInProgressRootRenderLanes, scheduleUpdateOnFiber, requestUpdateLane, requestEventTime, markSkippedUpdateLanes, isInvalidExecutionContextForEventFunction, getSuspendedThenableState } from './ReactFiberWorkLoop.old';
...
import { markStateUpdateScheduled, setIsStrictModeForDevtools } from './ReactFiberDevToolsHook.old';
...
import { prepareThenableState, trackUsedThenable, checkIfUseWrappedInTryCatch } from './ReactFiberThenable.old';
const {

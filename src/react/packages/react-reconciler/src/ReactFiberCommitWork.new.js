...
import { deferHiddenCallbacks, commitHiddenCallbacks, commitCallbacks } from './ReactFiberClassUpdateQueue.new';
...
import { TransitionRoot, TransitionTracingMarker } from './ReactFiberTracingMarkerComponent.new';

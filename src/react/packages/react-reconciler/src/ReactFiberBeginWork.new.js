...
import { markComponentRenderStarted, markComponentRenderStopped, setIsStrictModeForDevtools } from './ReactFiberDevToolsHook.new';
...
import { processUpdateQueue, cloneUpdateQueue, initializeUpdateQueue, enqueueCapturedUpdate } from './ReactFiberClassUpdateQueue.new';
...
import { pushHiddenContext, reuseHiddenContextOnStack } from './ReactFiberHiddenContext.new';
import { findFirstSuspended } from './ReactFiberSuspenseComponent.new';
import { pushProvider, propagateContextChange, lazilyPropagateParentContextChanges, propagateParentContextChangesToDeferredTree, checkIfContextChanged, readContext, prepareToReadContext, scheduleContextWorkOnParentPath } from './ReactFiberNewContext.new';
...
import { getIsHydrating, enterHydrationState, reenterHydrationStateFromDehydratedSuspenseInstance, resetHydrationState, claimHydratableSingleton, tryToClaimNextHydratableInstance, warnIfHydrating, queueHydrationError } from './ReactFiberHydrationContext.new';
...
import { resolveLazyComponentTag, createFiberFromTypeAndProps, createFiberFromFragment, createFiberFromOffscreen, createWorkInProgress, isSimpleFunctionComponent } from './ReactFiber.new';
import { retryDehydratedSuspenseBoundary, scheduleUpdateOnFiber, renderDidSuspendDelayIfPossible, markSkippedUpdateLanes, getWorkInProgressRoot } from './ReactFiberWorkLoop.new';
...
import { requestCacheFromPool, pushRootTransition, getSuspendedCache, pushTransition, getOffscreenDeferredCache, getPendingTransitions } from './ReactFiberTransition.new';
import { getMarkerInstances, pushMarkerInstance, pushRootMarkerInstance, TransitionTracingMarker } from './ReactFiberTracingMarkerComponent.new';

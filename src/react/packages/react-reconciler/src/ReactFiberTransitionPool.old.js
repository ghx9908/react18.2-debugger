...
export function pushRootTransitionPool(root) {
  if (enableCache) {
    return;
  }
...
export function popRootTransitionPool(root, renderLanes) {
  if (enableCache) {
    return;
  }
  // Note: This function currently does nothing but I'll leave it here for
...
export function pushTransitionPool(offscreenWorkInProgress, prevCachePool) {
  if (enableCache) {
...
export function popTransitionPool(workInProgress) {
  if (enableCache) {

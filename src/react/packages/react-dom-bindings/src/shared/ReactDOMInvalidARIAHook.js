...
function validateProperty(tagName, name) {
  if (__DEV__) {
    ...
    if (rARIACamel.test(name)) {
      ...
      const correctName = validAriaProperties.hasOwnProperty(ariaName) ? ariaName : null;
    ...
    if (rARIA.test(name)) {
      ...
      const standardName = validAriaProperties.hasOwnProperty(lowerCasedName) ? lowerCasedName : null;

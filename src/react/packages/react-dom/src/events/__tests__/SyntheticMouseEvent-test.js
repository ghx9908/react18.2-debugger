...
describe('SyntheticMouseEvent', () => {
  ...
  it('should only use values from movementX/Y when event type is mousemove', () => {
    ...
    const node = ReactDOM.render(<div onMouseMove={onMouseMove} onMouseDown={onMouseDown} />, container);
  ...
  it('should correctly calculate movementX/Y for capture phase', () => {
    ...
    const node = ReactDOM.render(<div onMouseMove={onMouseMove} onMouseMoveCapture={onMouseMoveCapture} onMouseDown={onMouseDown} onMouseDownCapture={onMouseDownCapture} />, container);
    let event = new MouseEvent('mousemove', {
      relatedTarget: null,
      bubbles: true,
      screenX: 2,

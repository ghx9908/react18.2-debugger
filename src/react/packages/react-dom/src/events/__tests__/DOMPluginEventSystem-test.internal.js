...
describe('DOMPluginEventSystem', () => {
  ...
  function withEnableLegacyFBSupport(enableLegacyFBSupport) {
    describe('enableLegacyFBSupport ' + (enableLegacyFBSupport ? 'enabled' : 'disabled'), () => {
      beforeAll(() => {
      ...
      it('handle propagation of click events between disjointed comment roots', () => {
        ...
        const disjointedNode = document.createComment(' react-mount-point-unstable ');
        ReactDOM.render(<Parent />, container);
        buttonRef.current.appendChild(disjointedNode);
        ReactDOM.render(<Child />, disjointedNode);
        const buttonElement = buttonRef.current;
      ...
      it('does not invoke an event on a parent tree when a subtree is dehydrated', async () => {
        ...
        if (gate(flags => flags.enableCapturePhaseSelectiveHydrationWithoutDiscreteEventReplay)) {
          expect(clicks).toBe(0);
        } else {
          expect(clicks).toBe(1);
        }
      ...
      it('handle click events on dynamic portals', async () => {
        ...
        function Parent() {
          ...
          React.useEffect(() => {
            setPortal(ReactDOM.createPortal(<span onClick={() => log.push('child')} id="child" />, ref.current));
          }, []);
      ...
      describe('ReactDOM.createEventHandle', () => {
        ...
        it('handle propagation of click events', () => {
          ...
          const onClickCapture = jest.fn(e => log.push(['capture', e.currentTarget]));
          const setClick = ReactDOM.unstable_createEventHandle('click');
          const setCaptureClick = ReactDOM.unstable_createEventHandle('click', {
            capture: true
          });
          function Test() {
            React.useEffect(() => {
              const clearClick1 = setClick(buttonRef.current, onClick);
              const clearCaptureClick1 = setCaptureClick(buttonRef.current, onClickCapture);
              const clearClick2 = setClick(divRef.current, onClick);
              const clearCaptureClick2 = setCaptureClick(divRef.current, onClickCapture);
              return () => {
                clearClick1();
                clearCaptureClick1();
                clearClick2();
        ...
        it('handle propagation of click events mixed with onClick events', () => {
          ...
          const onClickCapture = jest.fn(e => log.push(['capture', e.currentTarget]));
          const setClick = ReactDOM.unstable_createEventHandle('click');
          const setClickCapture = ReactDOM.unstable_createEventHandle('click', {
            capture: true
          });
          function Test() {
            React.useEffect(() => {
        ...
        it('should correctly handle many nested target listeners', () => {
          ...
          function Test() {
            React.useEffect(() => {
              const clearClick1 = setClick1(buttonRef.current, targetListener1);
              const clearClick2 = setClick2(buttonRef.current, targetListener2);
              const clearClick3 = setClick3(buttonRef.current, targetListener3);
              const clearClick4 = setClick4(buttonRef.current, targetListener4);
              return () => {
                clearClick1();
                clearClick2();
                clearClick3();
        ...
        it('handle propagation of click events on the window', () => {
          ...
          function Test() {
            React.useEffect(() => {
              ...
              const clearClickCapture1 = setClickCapture(window, onClickCapture);
              const clearClick2 = setClick(buttonRef.current, onClick);
              const clearClickCapture2 = setClickCapture(buttonRef.current, onClickCapture);
              const clearClick3 = setClick(divRef.current, onClick);
              const clearClickCapture3 = setClickCapture(divRef.current, onClickCapture);
              return () => {
                clearClick1();
                clearClickCapture1();
                clearClick2();
        ...
        it('should correctly handle stopPropagation for mixed listeners', () => {
          ...
          function Test() {
            React.useEffect(() => {
              ...
              const clearClick2 = setClick2(buttonRef.current, targetListener1);
              const clearClick3 = setClick3(window, rootListener2);
              const clearClick4 = setClick4(buttonRef.current, targetListener2);
              return () => {
                clearClick1();
                clearClick2();
                clearClick3();
        ...
        it('handle propagation of click events on the window and document', () => {
          ...
          function Test() {
            React.useEffect(() => {
              ...
              const clearClickCapture2 = setClickCapture(document, onClickCapture);
              const clearClick3 = setClick(buttonRef.current, onClick);
              const clearClickCapture3 = setClickCapture(buttonRef.current, onClickCapture);
              const clearClick4 = setClick(divRef.current, onClick);
              const clearClickCapture4 = setClickCapture(divRef.current, onClickCapture);
              return () => {
                clearClick1();
                clearClickCapture1();
                clearClick2();
        ...
        it('handle propagation of click events between disjointed comment roots', () => {
          ...
          function Parent() {
            React.useEffect(() => {
              ...
              const click2 = setClickCapture(buttonRef.current, onClickCapture);
              return () => {
                click1();
                click2();
              };
        ...
        it('propagates known createEventHandle events through portals without inner listeners', () => {
          ...
          function Parent() {
            React.useEffect(() => {
              ...
              const clear2 = setClickCapture(buttonRef.current, onClickCapture);
              return () => {
                clear1();
                clear2();
              };
        ...
        describe('Compatibility with Scopes API', () => {
          ...
          it('handle propagation of click events on a scope', () => {
            ...
            function Test() {
              ...
              React.useEffect(() => {
                ...
                const clear2 = setClickCapture(scopeRef.current, onClickCapture);
                return () => {
                  clear1();
                  clear2();
                };
          ...
          it('handle mixed propagation of click events on a scope', () => {
            ...
            function Test() {
              ...
              React.useEffect(() => {
                ...
                const clear4 = setClickCapture(buttonRef.current, onClickCapture);
                return () => {
                  clear1();
                  clear2();
                  clear3();
          ...
          it('should be able to register handlers for events affected by the intervention', () => {
            ...
            function Component() {
              React.useEffect(() => {
                const clearTouchStart = setTouchStart(ref.current, e => e.preventDefault());
                const clearTouchMove = setTouchMove(ref.current, e => e.preventDefault());
                const clearWheel = setWheel(ref.current, e => e.preventDefault());
                return () => {
                  clearTouchStart();
                  clearTouchMove();
                  clearWheel();

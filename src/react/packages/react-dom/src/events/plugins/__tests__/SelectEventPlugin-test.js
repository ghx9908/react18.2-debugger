...
describe('SelectEventPlugin', () => {
  ...
  it('does not get confused when dependent events are registered independently', () => {
    ...
    const node = ReactDOM.render(<input type="text" onMouseDown={function () {}} />, container);
  ...
  it('should fire `onSelect` when a listener is present', () => {
    ...
    const node = ReactDOM.render(<input type="text" onSelect={onSelect} />, container);
    node.focus();
  ...
  it('should fire `onSelectCapture` when a listener is present', () => {
    ...
    const node = ReactDOM.render(<input type="text" onSelectCapture={onSelectCapture} />, container);
    node.focus();
    let nativeEvent = new MouseEvent('focus', {
      bubbles: true,
      cancelable: true

...
const setUntrackedTextareaValue = Object.getOwnPropertyDescriptor(HTMLTextAreaElement.prototype, 'value').set;
describe('ChangeEventPlugin', () => {
  ...
  it('should consider initial text value to be current', () => {
    ...
    const node = ReactDOM.render(<input type="text" onChange={cb} defaultValue="foo" />, container);
  ...
  it('should consider initial text value to be current (capture)', () => {
    ...
    const node = ReactDOM.render(<input type="text" onChangeCapture={cb} defaultValue="foo" />, container);
    node.dispatchEvent(new Event('input', {
      bubbles: true,
      cancelable: true
    }));
  ...
  it('should consider initial checkbox checked=true to be current', () => {
    ...
    const node = ReactDOM.render(<input type="checkbox" onChange={cb} defaultChecked={true} />, container);
  ...
  it('should consider initial checkbox checked=false to be current', () => {
    ...
    const node = ReactDOM.render(<input type="checkbox" onChange={cb} defaultChecked={false} />, container);
  ...
  it('should fire change for checkbox input', () => {
    ...
    const node = ReactDOM.render(<input type="checkbox" onChange={cb} />, container);
  ...
  it('should not fire change setting the value programmatically', () => {
    ...
    const input = ReactDOM.render(<input type="text" defaultValue="foo" onChange={cb} />, container);
  ...
  it('should not distinguish equal string and number values', () => {
    ...
    const input = ReactDOM.render(<input type="text" defaultValue="42" onChange={cb} />, container);
  ...
  it('should not fire change when setting checked programmatically', () => {
    ...
    const input = ReactDOM.render(<input type="checkbox" onChange={cb} defaultChecked={false} />, container);
  ...
  it('should only fire change for checked radio button once', () => {
    ...
    const input = ReactDOM.render(<input type="radio" onChange={cb} />, container);
  ...
  it('should listen for both change and input events when supported', () => {
    ...
    const input = ReactDOM.render(<input type="range" onChange={cb} />, container);
  ...
  describe('concurrent mode', () => {
    it('text input', () => {
      ...
      class ControlledInput extends React.Component {
        ...
        render() {
          ...
          const controlledValue = this.state.value === 'changed' ? 'changed [!]' : this.state.value;
          return <input ref={el => input = el} type="text" value={controlledValue} onChange={this.onChange} />;
        }
      }
    ...
    it('checkbox input', () => {
      ...
      class ControlledInput extends React.Component {
        ...
        render() {
          ...
          const controlledValue = this.props.reverse ? !this.state.checked : this.state.checked;
          return <input ref={el => input = el} type="checkbox" checked={controlledValue} onChange={this.onChange} />;
        }
      }
    ...
    it('textarea', () => {
      ...
      class ControlledTextarea extends React.Component {
        ...
        render() {
          Scheduler.unstable_yieldValue(`render: ${this.state.value}`);
          const controlledValue = this.state.value === 'changed' ? 'changed [!]' : this.state.value;
          return <textarea ref={el => textarea = el} type="text" value={controlledValue} onChange={this.onChange} />;
        }
      }
      ...
      class ControlledInput extends React.Component {
        ...
        render() {
          ...
          return <div onChange={this.onChange}>
              <input ref={el => input = el} type="text" value={controlledValue} onChange={() => {
    ...
    it('is sync for non-input events', async () => {
      ...
      class ControlledInput extends React.Component {
        ...
        render() {
          Scheduler.unstable_yieldValue(`render: ${this.state.value}`);
          const controlledValue = this.state.value === 'changed' ? 'changed [!]' : this.state.value;
          return <input ref={el => input = el} type="text" value={controlledValue} onChange={this.onChange} onClick={this.reset} />;
        }
      }
    ...
    it('mouse enter/leave should be user-blocking but not discrete', async () => {
      ...
      function Foo() {
        ...
        return <div ref={target} onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>

...
describe('EnterLeaveEventPlugin', () => {
  ...
  it('should set onMouseLeave relatedTarget properly in iframe', () => {
    ...
    const leaveEvents = [];
    const node = ReactDOM.render(<div onMouseLeave={e => {
      e.persist();
      leaveEvents.push(e);
  ...
  it('should set onMouseEnter relatedTarget properly in iframe', () => {
    ...
    iframeDocument.close();
    const enterEvents = [];
    const node = ReactDOM.render(<div onMouseEnter={e => {
      e.persist();
      enterEvents.push(e);
    }} />, iframeDocument.body.getElementsByTagName('div')[0]);
  ...
  it('should find the common parent after updates', () => {
    ...
    class Parent extends React.Component {
      render() {
        return <div onMouseEnter={() => parentEnterCalls++} ref={node => parent = node}>

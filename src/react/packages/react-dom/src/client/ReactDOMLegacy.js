...
function legacyCreateRootFromDOMContainer(container, initialChildren, parentComponent, callback, isHydrationContainer) {
  if (isHydrationContainer) {
    ...
    const root = createHydrationContainer(initialChildren, callback, container, LegacyRoot, null,
    // hydrationCallbacks
    false,
    // isStrictMode
    false,
    ...
    const root = createContainer(container, LegacyRoot, null,
    // hydrationCallbacks
    false,
    // isStrictMode
    false,
...
export function unmountComponentAtNode(container) {
  ...
  if (container._reactRootContainer) {
    ...
    if (__DEV__) {
      ...
      const isContainerReactRoot = container.nodeType === ELEMENT_NODE && isValidContainerLegacy(container.parentNode) &&
